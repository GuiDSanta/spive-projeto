...
// Carrega foto do banco ao abrir a página
...
// Atualiza sessão com a foto atual do banco
...
<body>
    <div class="LogoSpive">
        ...
        <div class="text-center d-flex justify-content-center" role="alert" style="visibility: hidden" id="alertaerro">
    ...
    <script>
        ...
        email.addEventListener("invalid", function() {
            if (email.validity.valueMissing) {
                email.setCustomValidity("Por favor, preencha o campo de e-mail.");
            } else if (email.validity.typeMismatch) {
                email.setCustomValidity("Digite um endereço de e-mail válido (ex: usuario@gmail.com).");
            }
        });

        email.addEventListener("input", function() {
            email.setCustomValidity(""); // limpa a mensagem quando o usuário corrige
        });
    </script>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                    ...
                    <button class="btn btn-primary w-100 my-2" onclick="tirarFoto()">
                        Tirar foto/Galeria
                    </button>

                    <form action="remover_foto.php" method="POST">
                        <button class="btn btn-primary w-100 my-2" type="submit" class="btn btn-danger">Remover foto</button>
                    </form>


                    <!-- input escondido para escolher da galeria -->
                    <input type="file" id="inputGaleria" accept="image/*" style="display:none" onchange="carregarGaleria(event)">
                </div>
...
<script>
    ...
    function retirar() {
        document.getElementById("fotoperfil").src = "img/account_circle_140dp_FFFFFF_FILL0_wght400_GRAD0_opsz48.png";
    }
</script>
